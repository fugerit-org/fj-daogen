 ...
 */
public class LoadUserHelper extends org.fugerit.java.daogen.sample.helper.ServiceProviderHelper<ModelUser> {

	// custom code start ( code above here will be overwritten )
	// custom code end ( code below here will be overwritten )

	private static final long serialVersionUID = 315520622489L;
