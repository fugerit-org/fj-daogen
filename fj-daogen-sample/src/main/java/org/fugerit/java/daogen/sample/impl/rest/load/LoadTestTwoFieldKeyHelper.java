...
/**
 * LoadTestTwoFieldKeyHelper, version : 1.0.0
 *
 * author: fugerit
 *
 ...
 */
public class LoadTestTwoFieldKeyHelper extends org.fugerit.java.daogen.sample.helper.ServiceProviderHelper<ModelTestTwoFieldKey> {

	// custom code start ( code above here will be overwritten )
	// custom code end ( code below here will be overwritten )

	private static final long serialVersionUID = 777241815850L;
