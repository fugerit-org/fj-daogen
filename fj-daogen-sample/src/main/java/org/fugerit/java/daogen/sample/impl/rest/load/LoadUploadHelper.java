...
/**
 * LoadUploadHelper, version : 1.0.0
 *
 * author: fugerit
 *
 ...
 */
public class LoadUploadHelper extends org.fugerit.java.daogen.sample.helper.ServiceProviderHelper<ModelUpload> {

	// custom code start ( code above here will be overwritten )
	// custom code end ( code below here will be overwritten )

	private static final long serialVersionUID = 168672503212L;
