...
/**
 * LoadLogDataHelper, version : 1.0.0
 *
 * author: fugerit
 *
 ...
 */
public class LoadLogDataHelper extends org.fugerit.java.daogen.sample.helper.ServiceProviderHelper<ModelLogData> {

	// custom code start ( code above here will be overwritten )
	// custom code end ( code below here will be overwritten )

	private static final long serialVersionUID = 250934820120L;
