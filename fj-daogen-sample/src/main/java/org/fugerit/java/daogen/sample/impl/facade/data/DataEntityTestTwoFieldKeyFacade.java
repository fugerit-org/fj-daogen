...
/**
 * DataEntityTestTwoFieldKeyFacade, version : 1.0.0
 *
 * author: fugerit
 *
 ...
 */
public class DataEntityTestTwoFieldKeyFacade extends BasicDataFacade<ModelTestTwoFieldKey> implements EntityTestTwoFieldKeyFacade {

	// custom code start ( code above here will be overwritten )
	// custom code end ( code below here will be overwritten )

	private static final long serialVersionUID = 885103477117L;

	public DataEntityTestTwoFieldKeyFacade() {
